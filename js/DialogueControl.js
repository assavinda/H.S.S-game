export class DialogueControl {
  constructor() {
    this.script = {
      lobby: [
        [
          `ยินดีต้อนรับคุณผู้มาเยือนยามวิกาล ที่นี่คือ H.S.S. สถานที่ซึ่งรวบรวมเอาไว้ด้วยศิลปะแห่งความงามของการฆ่าฟัน ร้านของพวกเราเต็มไปด้วยสิ่งของสวยงามมากมาย การที่ได้พบเจอกับคุณ คงเป็นเพราะโชคชะตาที่นำพาให้คุณพลัดมาถึงที่นี่แน่ครับ`,
          0
        ],
        [
